...
ts <- seq(from=1, to=N_TIME_STEPS, by=TIME_STEP)
...
plot(temp$x, temp$y, xlab = "time", ylab = "cases", 
     main = paste("Fitting of empirical data using", TIME_STEP, "days as time step"))
...
# plot
plot(dfdt$time, dfdt$empirical)
# plot 2
points(dfdt$time, dfdt$estimated, pch = 8) 
